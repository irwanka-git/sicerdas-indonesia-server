...
func newRole(db *gorm.DB, opts ...gen.DOOption) role {
	...
	_role.IDRole = field.NewInt32(tableName, "id_role")
	_role.NamaRole = field.NewString(tableName, "nama_role")
	_role.AksesGlobal = field.NewInt32(tableName, "akses_global")
	_role.UUID = field.NewString(tableName, "uuid")
...
type role struct {
	...
	ALL         field.Asterisk
	IDRole      field.Int32
	NamaRole    field.String
	AksesGlobal field.Int32
	UUID        field.String
...
func (r *role) updateTableName(table string) *role {
	...
	r.NamaRole = field.NewString(table, "nama_role")
	r.AksesGlobal = field.NewInt32(table, "akses_global")
...
func (r *role) fillFieldMap() {
	...
	r.fieldMap["nama_role"] = r.NamaRole
	r.fieldMap["akses_global"] = r.AksesGlobal
