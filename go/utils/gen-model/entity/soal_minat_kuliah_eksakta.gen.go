...
const TableNameSoalMinatKuliahEksaktum = "soal_minat_kuliah_eksakta"

// SoalMinatKuliahEksaktum mapped from table <soal_minat_kuliah_eksakta>
...
// TableName SoalMinatKuliahEksaktum's table name
func (*SoalMinatKuliahEksaktum) TableName() string {
	return TableNameSoalMinatKuliahEksaktum
}
