...
const TableNameRefRekomendasiAkhirMan = "ref_rekomendasi_akhir_man"

// RefRekomendasiAkhirMan mapped from table <ref_rekomendasi_akhir_man>
...
// TableName RefRekomendasiAkhirMan's table name
func (*RefRekomendasiAkhirMan) TableName() string {
	return TableNameRefRekomendasiAkhirMan
}
