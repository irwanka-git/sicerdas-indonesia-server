...
const TableNameSoalKognitif = "soal_kognitif"

// SoalKognitif mapped from table <soal_kognitif>
...
// TableName SoalKognitif's table name
func (*SoalKognitif) TableName() string {
	return TableNameSoalKognitif
}
