...
const TableNameSoalModeKerjaEng = "soal_mode_kerja_eng"

// SoalModeKerjaEng mapped from table <soal_mode_kerja_eng>
...
// TableName SoalModeKerjaEng's table name
func (*SoalModeKerjaEng) TableName() string {
	return TableNameSoalModeKerjaEng
}
