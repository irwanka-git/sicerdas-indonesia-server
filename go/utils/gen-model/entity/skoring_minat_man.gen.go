...
const TableNameSkoringMinatMan = "skoring_minat_man"

// SkoringMinatMan mapped from table <skoring_minat_man>
...
// TableName SkoringMinatMan's table name
func (*SkoringMinatMan) TableName() string {
	return TableNameSkoringMinatMan
}
