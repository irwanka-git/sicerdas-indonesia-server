...
const TableNameSkoringMinatSmaV2 = "skoring_minat_sma_v2"

// SkoringMinatSmaV2 mapped from table <skoring_minat_sma_v2>
...
// TableName SkoringMinatSmaV2's table name
func (*SkoringMinatSmaV2) TableName() string {
	return TableNameSkoringMinatSmaV2
}
