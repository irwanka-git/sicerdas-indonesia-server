...
const TableNameSkoringMinatSmk = "skoring_minat_smk"

// SkoringMinatSmk mapped from table <skoring_minat_smk>
...
// TableName SkoringMinatSmk's table name
func (*SkoringMinatSmk) TableName() string {
	return TableNameSkoringMinatSmk
}
