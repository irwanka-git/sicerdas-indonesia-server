...
const TableNameSoalGayaPekerjaanEng = "soal_gaya_pekerjaan_eng"

// SoalGayaPekerjaanEng mapped from table <soal_gaya_pekerjaan_eng>
...
// TableName SoalGayaPekerjaanEng's table name
func (*SoalGayaPekerjaanEng) TableName() string {
	return TableNameSoalGayaPekerjaanEng
}
