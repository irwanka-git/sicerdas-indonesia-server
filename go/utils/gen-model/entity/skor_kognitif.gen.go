...
const TableNameSkorKognitif = "skor_kognitif"

// SkorKognitif mapped from table <skor_kognitif>
...
// TableName SkorKognitif's table name
func (*SkorKognitif) TableName() string {
	return TableNameSkorKognitif
}
