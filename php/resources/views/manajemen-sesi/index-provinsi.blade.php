 ...
 <div class="container-fluid p-0">
					...
					<nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
					  <ol class="breadcrumb">
					    ...
					    <li class="breadcrumb-item active">{{$data_biro['nama_biro']}} ({{$data_biro['jumlah_tes']}})</li>
					  </ol>
					</nav>
					<div class="row">
						...
						<div class="col-12 col-md-6 col-lg-3">
							<div class="card">
								<div class="card-header px-4 pt-4">
									...
									$url_detil = url('/manajemen-sesi/explore/'.$data_tahun['tahun'].'/'.$data_biro['id_user_biro'].'/'.$r->kode_provinsi);
									?>
									<a href="{{$url_detil}}"><h5 class="card-title mb-0"><i class="las la-map-marker-alt"></i> {{$r->provinsi}}</h5></a>
