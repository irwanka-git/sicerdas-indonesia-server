...
$list_bidang = get_list_enum_values('soal_kognitif_eng','bidang');
$list_paket = get_list_enum_values('soal_kognitif_eng','paket');
$list_petunjuk = DB::table('petunjuk_soal_eng')
			...
			<div class="col-12">
				...
				<div class="card">
					<div class="card-header">
						<h5 class="card-title">Soal-Soal Test IQ Kompetensi Dasar</h5>
						<h6 class="card-subtitle text-muted">Fitur Ini Digunakan Untuk Input Soal-Soal IQ Kompetensi Dasar </h6>
					</div>
					<div class="card-body">
						@if(ucc())
