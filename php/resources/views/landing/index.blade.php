    ...
    <section  id="feature"  class="bg-white dark:bg-gray-800 pb-4">
        <div class="max-w-screen-xl px-4 pb-8 mx-auto space-y-12">
                <div class="text-gray-500 px-4 pt-8 sm:text-lg dark:text-gray-400">
                    ...
                    ?>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 m-2">
                ...
                <div class="p-6 bg-white border border-gray-200">
                    <div class="flex space-x-3">
                        ...
                        <span class="text-base  leading-tight text-gray-900 dark:text-white"><b><a href="{{url('landing-detil/'.$paket->uuid)}}">{{$paket->kode}} - {{$paket->nama_tarif}}</a></b> <br> @ Rp. {{number_format($paket->tarif,0,",",".")}} /Peserta</span>
                    </div>
                </div>
                @endforeach
            </div>
