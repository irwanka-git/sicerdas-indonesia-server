...
{{ Form::bsOpen('form-tambah',url($main_path."/insert")) }}
	{{Html::mOpenLG('modal-tambah','Tambah Jenis Tes')}}
		...
		<div class="mb-3">
			...
			<p>Dapat menggunakan template canva berikut <a target="_blank" href="https://www.canva.com/design/DAF0XkjwAyY/R8Y56zNAbVvITMEsT2uDgQ/edit?utm_content=DAF0XkjwAyY&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton"> Template</a></p>
