			...
			<div class="col-12">
				<div class="card">
					<div class="card-header">
						<h5 class="card-title">Pilihan Tes Minat Kuliah Kedinasan</h5>
						<h6 class="card-subtitle text-muted">Fitur Ini Digunakan Untuk Input Data Pilihan Tes Minat Kuliah Kedinasan </h6>
					</div>
					<div class="card-body">
						@if(ucc())
