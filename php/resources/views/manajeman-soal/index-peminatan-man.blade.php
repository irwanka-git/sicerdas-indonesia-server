			...
			<div class="col-12">
				<div class="card">
					<div class="card-header">
						<h5 class="card-title">Soal Skala Peminatan - MAN</h5>
						<h6 class="card-subtitle text-muted">Fitur Ini Digunakan Untuk Manajemen Soal / Pernyataan Tentang Skala Peminatan MAN </h6>
					</div>
					<div class="card-body">
						@if(ucc())
...
<script type="text/javascript">
	$(function(){
			...
			var $tabel1 = $('#datatable').DataTable({
			    ...
			    fixedHeader: true,
			    serverSide: true,
			    ajax: "{{url('soal-skala-peminatan-man/dt')}}",
			    "iDisplayLength": 25,
			    columns: [
			...
			//handle lihat soal
			 $("#modal-lihat-soal").on('show.bs.modal', function(e){
				...
				$.get("{{url('soal-skala-peminatan-man/lihat-soal')}}/"+$uuid, function(respon){
		...
		$("#modal-edit").on('show.bs.modal', function(e){
			...
			$.get("{{url('soal-skala-peminatan-man/get-data')}}/"+$uuid, function(respon){
				if(respon.status){
