...
$list_kelompok = get_list_enum_values('soal_sikap_pelajaran','kelompok');
?>
@extends('layout')
@section("css")
			...
			<div class="col-12">
				<div class="card">
					<div class="card-header">
						<h5 class="card-title">Sikap Terhadap Pelajaran</h5>
...
<script type="text/javascript">
	$(function(){
			...
			var $tabel1 = $('#datatable').DataTable({
			    ...
			    fixedHeader: true,
			    serverSide: true,
			    ajax: "{{url('soal-sikap-pelajaran/dt')}}",
			    "iDisplayLength": 25,
			    columns: [
			...
			//handle lihat soal
			 $("#modal-lihat-soal").on('show.bs.modal', function(e){
				...
				$.get("{{url('soal-sikap-pelajaran/lihat-soal')}}/"+$uuid, function(respon){
		...
		$("#modal-edit").on('show.bs.modal', function(e){
			...
			$.get("{{url('soal-sikap-pelajaran/get-data')}}/"+$uuid, function(respon){
				if(respon.status){
