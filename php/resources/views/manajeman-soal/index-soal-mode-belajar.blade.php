...
{{ Form::bsOpen('form-tambah',url($main_path."/insert")) }}
	...
	{{ Form::bsTextField('Aspek / Suasana Belajar','suasana_belajar','',true,'md-8') }}
...
<script type="text/javascript">
	$(function(){
		...
		$("#modal-edit").on('show.bs.modal', function(e){
			...
			$.get("{{url('soal-mode-belajar/get-data')}}/"+$uuid, function(respon){
				if(respon.status){ 
					...
					$('#form-edit #suasana_belajar').val(respon.data.suasana_belajar);
