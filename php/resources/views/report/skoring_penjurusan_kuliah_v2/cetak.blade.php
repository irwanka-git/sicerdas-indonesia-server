...
<img class="kop" src="{{'/kop/'.$biro->kop_biro}}" height="80px">
	...
	<?php
	 $ttd_mengetahui = DB::table('quiz_sesi_ttd')->where('id_quiz', $data_sesi->id_quiz)->first();
	?>
  ...
  @else
	...
	@include("report.".$data_sesi->skoring_tabel.".deskripsi-gaya-pekerjaan")
	<p class="new-page"></p>
	@include("report.".$data_sesi->skoring_tabel.".deskripsi-komponen")
@endsection
