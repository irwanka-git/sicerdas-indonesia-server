...
<img class="kop" src="{{'/kop/'.$biro->kop_biro}}" height="80px">
	...
	<table width="100%">
		...
		<tr>
			<td>Jenis Kelamin</td>
			<td>:</td>
			<td>{{($user->jenis_kelamin=='L' || $user->jenis_kelamin=='M') ? 'Laki-Laki' : 'Perempuan'}}</td>
			<td>Tanggal Tes</td>
			<td>:</td>
	...
	<p class="new-page"></p>
	@include("report.".$data_sesi->skoring_tabel.".minat-kuliah-sains")<br>
	@include("report.".$data_sesi->skoring_tabel.".minat-kuliah-sosial")<br>
