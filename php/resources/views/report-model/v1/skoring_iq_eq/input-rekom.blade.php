...
<div class="row justify-content-center mt-3 mb-2">
	<div class="col-auto">
		<nav class="nav btn-group">
			...
			<a href="#aspek-kognitif" class="btn btn-outline-primary" data-bs-toggle="tab">TKD (IQ)</a>
			<a href="#karakter-pribadi1" class="btn btn-outline-primary" data-bs-toggle="tab">ASPEK SIKAP KERJA (EQ)</a>
			<a href="#karakter-pribadi2" class="btn btn-outline-primary" data-bs-toggle="tab">ASPEK KEPRIBADIBADIAN (EQ)</a>
		</nav>
	</div>
</div>
