<table class="table table-striped table-sm table-bordered table-x">
    <thead>
        <tr class="table-primary">
            <th colspan="2" class="box-header text-center sm">REKOMENDASI JURUSAN KULIAH</th>
        </tr>
    </thead>
    <tbody>
         <tr>
        ...
        <tr>
         ...
         <tr>
             <td class="sm"  colspan="2">
                <b>JURUSAN UIN/IAIN (ILMU AGAMA) :</b><br>
                <?php
                    $list_agm = DB::select("SELECT *  FROM soal_minat_kuliah_agama");
                    $data_jawaban = $data_sesi->jawaban_skoring;
                    $obj = json_decode($data_jawaban);
