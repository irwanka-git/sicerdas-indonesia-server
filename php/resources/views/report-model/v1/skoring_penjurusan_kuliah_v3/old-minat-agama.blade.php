...
<table class="table table-striped table-sm table-bordered table-x">
	<thead>
		<tr class="table-primary">
			<th colspan="2" class="text-center box-header sm">MINAT JURUSAN UIN/IAIN (ILMU AGAMA)</th>
		</tr>
		<tr class="table-primary">
	...
	<tbody>
        ...
        <tr>
            <td align="center" class="text-center sm box-cell-info">
                 {{$value->urutan}}
            </td>
            <td class="jf box-cell-info">
                @foreach ($list as $l)
