...
<div style="margin-bottom: 20px; margin-top: 30px;">
	...
	<p class="new-page"></p>
	@include("report-model.v1.".$data_sesi->skoring_tabel.".minat-agama")
	<br>
	@include("report-model.v1.".$data_sesi->skoring_tabel.".minat-kedinasan")
	
	<p class="new-page"></p>
	@include("report-model.v1.".$data_sesi->skoring_tabel.".gaya-belajar")
	<br>
	@include("report-model.v1.".$data_sesi->skoring_tabel.".gaya-pekerjaan")
	...
	@if($data_sesi->ttd_asesor)
	  ...
	  @endif
	  <p class="new-page"></p>
	@include("report-model.v1.".$data_sesi->skoring_tabel.".deskripsi-gaya-pekerjaan")
	@include("report-model.v1.".$data_sesi->skoring_tabel.".deskripsi-komponen")
