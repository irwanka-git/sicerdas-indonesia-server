...
<div class="row justify-content-center mt-3 mb-2">
	<div class="col-auto">
		<nav class="nav btn-group">
			...
			<a href="#minat_kuliah_sains" class="btn btn-outline-primary" data-bs-toggle="tab">MINAT KULIAH SAINS</a>
			<a href="#minat_kuliah_sosial" class="btn btn-outline-primary" data-bs-toggle="tab">MINAT KULIAH SOSIAL</a>
			<a href="#minat_kuliah_dinas" class="btn btn-outline-primary" data-bs-toggle="tab">MINAT KULIAH DINAS</a>
...
<div class="tab-content">
					...
					<table class="table table-striped table-sm table-bordered  table-x">
						<thead>
							<tr>
								...
								<th class="text-center sm">KELAS</th>
							</tr>
						</thead>
						<tbody>
							<tr>
								...
								<td align="center">{{strtoupper(str_replace("_"," ",$data_skoring->rekom_kelas))}}</td>
							</tr>
						</tbody>
					</table>
				</div>
	...
	<div class="tab-pane py-2 fade" id="peminatan-sma">
		<div class="card">
			<div class="card-body">
				@include("report.".$data_sesi->skoring_tabel.".minat-sma")
			</div>
		</div>
	</div>
	...
	<div class="tab-pane py-2 fade" id="minat_kuliah_sains">
		<div class="card">
			<div class="card-body">
				@include("report.".$data_sesi->skoring_tabel.".minat-kuliah-sains")
			</div>
		</div>
	</div>
	<div class="tab-pane py-2 fade" id="minat_kuliah_sosial">
		<div class="card">
			<div class="card-body">
				@include("report.".$data_sesi->skoring_tabel.".minat-kuliah-sosial")
			</div>
		</div>
	</div>
	<div class="tab-pane py-2 fade" id="minat_kuliah_dinas">
		<div class="card">
			<div class="card-body">
				@include("report.".$data_sesi->skoring_tabel.".minat-kuliah-dinas")
			</div>
		</div>
	</div>
