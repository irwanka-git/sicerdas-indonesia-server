...
class SkoringMinatSMK extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'skoring:peminatan_smk';
    ...
    public function handle()
    {
        ...
        foreach ($quiz as $qz){
            ...
            if($ada_skoring > 0){
                ...
                $this->skoring_minat_smk($qz->id_quiz);
        ...
        if( $jumlah_running_skoring > 0){
            DB::table('running_cronjob')->insert(['nama'=>"skoring:peminatan_smk",'start_at'=>$start_at, 'finish_at'=>$finish_at, 'peserta'=>$jumlah_running_skoring]);
    ...
    public function skoring_kognitif($id_quiz){
     ...
     //rekom smk
    public function skoring_minat_smk ($id_quiz){
