...
class SkoringMinatSMAVERSI2 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'skoring:peminatan_sma_v2';
    ...
    private $tabel_skoring_induk = 'skoring_minat_sma_v2';
    ...
    private $tabel_referensi_rekomendasi_akhir = 'ref_rekomendasi_akhir_sma_v2';
    ...
    public function finishing_skoring($id_quiz) {
        ...
        $skor_kelas = DB::select("SELECT A.id_quiz,
                            ...
                            CASE
                                ...
                                END AS rekom_kelas 
                            FROM
                                skoring_minat_sma_v2 AS A, soal_minat_kuliah_eksakta AS d,
