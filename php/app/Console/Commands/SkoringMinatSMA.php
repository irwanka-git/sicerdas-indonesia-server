...
class SkoringMinatSMA extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'skoring:peminatan_sma';
     ...
     * Execute the console command.
        ...
        SKALA_PEMINATAN_SMA                 >>> SKORING_MINAT_SMA
    ...
    private $tabel_skoring_induk = 'skoring_minat_sma';
    ...
    public function handle()
    {
        ...
        if( $jumlah_running_skoring > 0){
            DB::table('running_cronjob')->insert(['nama'=>"skoring:peminatan_sma",'start_at'=>$start_at, 'finish_at'=>$finish_at, 'peserta'=>$jumlah_running_skoring]);
