...
class SkoringJurusanKuliahVERSI2 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'skoring:penjurusan_kuliah_v2';
    ...
    private $tabel_skoring_induk = 'skoring_penjurusan_kuliah_v2';
